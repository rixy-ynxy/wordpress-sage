...
<section id="comments" class="comments">
  @if (have_comments())
    <h2>
      {!! sprintf(_nx('回答が1つあります。 &ldquo;%2$s&rdquo;', '%1$s 回答があります： &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'sage'), number_format_i18n(get_comments_number()), '<span>' . get_the_title() . '</span>') !!}
    </h2>
